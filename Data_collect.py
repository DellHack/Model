...
actions = np.array(['Hello','My Name is','Day'])

sequences = 7
frames = 30

# Set path where the dataset will be stored
PATH = os.path.join('data6')

# Creating directories for each action, sequence, and frame in the dataset
